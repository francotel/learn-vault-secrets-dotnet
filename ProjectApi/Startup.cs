  ...
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      if (Configuration["database:userID"] != null) {
        ...
        //Console.WriteLine($"Password: {dbBuilder.Password ?? "null"}");
        //Console.WriteLine($"UserID: {dbBuilder.UserID ?? "null"}");

        // Aquí se configuran las propiedades para deshabilitar TLS/SSL
        dbBuilder.Encrypt = false;  // Deshabilitar la encriptación
        dbBuilder.TrustServerCertificate = true;  // Aceptar cualquier certificado del servidor sin validación
